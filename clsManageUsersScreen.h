...
private:
    ...
    {
       // cout << "\t\tList Users Screen will be hear\n
        clsListUsersScreen::ShowUsersList();
    }

    static void _ShowAddNewUserScreen()
    {
        //cout << "\t\tAdd New User Screen will be hear\n";
        clsAddNewUserScreen::ShowAddNewUserScreen();
    }

    static void _ShowDeleteUserScreen()
    {
       // cout << "\t\Delete User Screen will be hear\n";
        clsDeleteUserScreen::ShowDeleteUserScreen();
    }

    static void _ShowUpdateUserScreen()
    {
         // cout << "\tUpdate User Screen will be hear\n";
        clsUpdateUserScreen::ShowUpdateUserScreen();
    }

    static void _ShowFindUserScreen()
    {
        // cout << "\t\Find User Screen will be hear\n";
    ...
    static void _PerformManageUsersMenueOption(enManageUsersMenueOptions ManageUsersMenueOptions)
    {
        ...
        case clsManageUsersScreen::eMainMenue:
            // Nothing will be hear the main menue screen will handle this :-)
            break;
        default:
            break;
        }
